...
class ShowGeneral extends StatefulWidget {
  const ShowGeneral({Key? key}) : super(key: key);

  @override
  _ShowGeneralState createState() => _ShowGeneralState();
}

class _ShowGeneralState extends State<ShowGeneral> {
